...
class ComparisonFragment :
    ...
    private fun setData(stats: MatchStatsUI) {
        ...
        binding.imgPlayer1Item0.load(player1.item0)
        binding.imgPlayer1Item1.load(player1.item1)
        binding.imgPlayer1Item2.load(player1.item2)
        binding.imgPlayer1Item3.load(player1.item3)
        binding.imgPlayer1Item4.load(player1.item4)
        binding.imgPlayer1Item5.load(player1.item5)

        binding.imgPlayer1Backpack0.load(player1.backpack0)
        binding.imgPlayer1Backpack1.load(player1.backpack1)
        binding.imgPlayer1Backpack2.load(player1.backpack2)
        binding.imgPlayer1ItemNeutral.load(player1.itemNeutral)

        binding.imgPlayer2Item0.load(player2.item0)
        binding.imgPlayer2Item1.load(player2.item1)
        binding.imgPlayer2Item2.load(player2.item2)
        binding.imgPlayer2Item3.load(player2.item3)
        binding.imgPlayer2Item4.load(player2.item4)
        binding.imgPlayer2Item5.load(player2.item5)

        binding.imgPlayer2Backpack0.load(player2.backpack0)
        binding.imgPlayer2Backpack1.load(player2.backpack1)
        binding.imgPlayer2Backpack2.load(player2.backpack2)
        binding.imgPlayer2ItemNeutral.load(player2.itemNeutral)
    }
